ActiveAdmin.register FaqDoctor do
  menu priority: 1, parent: 'T&C and Help', label: "FAQ Doctors"
  config.batch_actions = false

  permit_params :title, :content, :is_published

  index :download_links => false, :title => "FAQ Doctors" do
    selectable_column
    id_column
